...
router.get('/', isLoggedIn, async (req, res) => {
   ...
   // res.render("catalogo/template1", { info });
   ...
   var dat = Math.random();
    ...
    var document = {
        ...
        path: "./" + dat + "catalogo.pdf"    // it is not required if type is buffer
    };
    ...
    pdf.create(document, options)
        .then(resp => {
            ...
            fs.readFile(process.cwd() + slash + dat + "catalogo.pdf", (err, data) => {
            ...
            fs.unlink(process.cwd() + slash + dat + "catalogo.pdf", (err) => {
